"""
Django settings for alireviewstuff project.
...
SECRET_KEY = '@hg2+bfggy@x3)&cvdz*&656n*_c^ls_vl33u#%5jq#!8a*c*&'
...
ROOT_URLCONF = 'alireviewstuff.urls'
...
WSGI_APPLICATION = 'alireviewstuff.wsgi.application'
